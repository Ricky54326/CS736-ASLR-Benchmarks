jpeg("entropy2-freebsd.jpg");
vec <- read.csv("/home/r/riccardo/Development/CS736-ASLR-Benchmarks/entropy2-freebsd.txt-clean.csv")
#vec <- read.csv("http://www.upl.cs.wisc.edu/~riccardo/entropy1-debian-clean.csv")
y <- vec$high
x <- vec$low


plot(x, y, main="FreeBSD - Heap", xaxt = "n", yaxt = "n",
